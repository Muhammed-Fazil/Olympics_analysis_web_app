...
def medal_tally(df):
    # Resolving the problem in group event instead of calucalting one medal for team data calculates single medal for
    # each person in medal counts
...
def weight_v_height(df,sport):
    athlete_df = df.drop_duplicates(subset=['Age', 'region'])
